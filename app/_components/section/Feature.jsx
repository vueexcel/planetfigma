...
const Feature = () => {
    ...
    return (
        <div className="justify-around w-full px-4 mt-32 mg:flex mg:px-12">
            <div className="bg-[#151719] w-full max-w-[530px] mg:max-w-[600px] mx-auto mg:mx-0 mg:min-w-[480px] mg:max-h-[300px]">
            ...
            <ul ref={scrollView} className="flex ml-6 items-center mt-6 mg:max-w-[500px] overflow-x-auto pointer-events-none mg:pr-8 mg:mt-0 mg:flex-col no-scroll-view" style={{ transform: `translateX(-${scrollIndex * 100}%})` }}>
                <li className="flex-shrink-0 w-full mb-4 mr-1 mg:flex-shrink mg:mr-0 mg:mb-10">
                    <Image
                        src="/images/f1.png"
